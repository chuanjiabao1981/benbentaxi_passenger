...
public class UrlConfigure extends IdShow {
	...
	private final static String URL_TITLE		 = "�����������ַ";
	...
	private void init()
	{
		...
		super.SetPositiveOnclick("ȷ��", new OnClickListener()
		{
				...
				int which)
			{
				...
				Toast.makeText(UrlConfigure.this.mA, "�Ѿ������������ַ: "+myUrl, Toast.LENGTH_SHORT).show();
				Toast.makeText(UrlConfigure.this.mA, "���ڼ���...", Toast.LENGTH_SHORT).show();
